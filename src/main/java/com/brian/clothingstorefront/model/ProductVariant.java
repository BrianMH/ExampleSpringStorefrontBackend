...
public class ProductVariant {
    ...
    public boolean equals(Object o) {
        ...
        return id == that.id && Double.compare(priceInCents, that.priceInCents) == 0 && Objects.equals(mainProd, that.mainProd) && Objects.equals(size, that.size) && Objects.equals(color, that.color);
    }

    @Override
    public int hashCode() {
        return Objects.hash(id, mainProd, size, color, priceInCents);
    }
}
